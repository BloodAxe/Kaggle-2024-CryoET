...
do
  ...
  --fold=$FOLD  --max_grad_norm=3 --ddp_find_unused_parameters=True --ema --early_stopping=25 --use_stride4=False \
  --copy_paste_prob=0.2 --random_erase_prob=0.2 --mixup_prob=0.2 --use_6_classes=True --use_cross_entropy_loss=True
done
