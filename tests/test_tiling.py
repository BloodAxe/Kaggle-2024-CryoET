...
def test_tiling():
    ...
    tiles = compute_tilets(volume_shape, window_size=(96, 128, 128), stride=(62, 90, 90))
    tiles = list(tiles)
    print(len(tiles), tiles[-1])

    tiles = compute_better_tiles(volume_shape, window_size=(96, 128, 128), window_step=(62, 90, 90))
    tiles = list(tiles)
    print(len(tiles), tiles[-1])
