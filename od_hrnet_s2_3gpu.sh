...
do
  ...
  --fold=$FOLD  --max_grad_norm=3 --ddp_find_unused_parameters=True --early_stopping=25 --use_stride4=False --use_6_classes=True \
  --copy_paste_prob=0.2 --random_erase_prob=0.2 --mixup_prob=0.2 --use_cross_entropy_loss=True --ema
