...
do
  ...
  torchrun --standalone --nproc-per-node=4 train_od.py \
    ...
    --per_device_train_batch_size=6 --learning_rate=1e-4 --weight_decay=0.01 \
    ...
    --fold=$FOLD  --max_grad_norm=3 --ddp_find_unused_parameters=True --early_stopping=25 --use_stride2=False --use_stride4=True \
  ...
  torchrun --standalone --nproc-per-node=4 train_od.py \
    ...
    --dataloader_num_workers=4 --dataloader_persistent_workers=True --dataloader_pin_memory=True \
    --y_rotation_limit=10 --x_rotation_limit=10 \
    --num_train_epochs=5 --warmup_steps=64 --average_tokens_across_devices=True  --use_instance_crops=True --use_random_crops=True \
    --fold=0  --max_grad_norm=3 --ddp_find_unused_parameters=True --early_stopping=25 --use_stride2=False --use_stride4=True \
    --copy_paste_prob=0.2 --random_erase_prob=0.2 --mixup_prob=0.2 \
    --use_6_classes=True